...
/**
    ...
    public void registerSessionId(String user,String sessionId){
        ...
        Assert.notNull(sessionId,"SessionId must no be null");
    ...
    public void unregisterSessioinId(String userName,String sessionId){
        Assert.notNull(userName,"User name must mo be null");
